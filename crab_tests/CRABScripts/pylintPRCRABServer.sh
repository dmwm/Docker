...
while read name; do
  pylint --evaluation='10.0 - ((float(5 * error + warning) / statement) * 10)' --rcfile /home/dmwm/crabserver_test/.pylintrc -d C0103 -f parseable $name > pylint.out || true
